...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    AppComponent$(_ref) {
      ...
      t4.Ackable$0();
      t4 = new A.AppComponent(t4, _ref, B.Map_wwVUC, B.Map_WVgPO, A._setArrayType([], type$.JSArray_Walk));
    ...
    AppComponent: function AppComponent(t0, t1, t2, t3, t4) {
      var _ = this;
      _._windowMsgAck = t0;
      _._ref = t1;
      _._item = t2;
      _.chosenViewingOption = _._viewingOptions = _._viewing = null;
      _._subitem = t3;
      _.walked = t4;
      _._currentWalk = null;
      _._isFetching = true;
  ...
  A._ViewAppComponent2.prototype = {
    ...
    detectChangesInternal$0() {
      var currVal_0, _this = this,
        ...
        currVal_1 = J.get$keys$x(_ctx._item),
        t1 = _this._expr_1;
      if (t1 !== currVal_1) {
  ...
  A._ViewAppComponent3.prototype = {
    ...
    detectChangesInternal$0() {
      ...
      if (t3 !== local_key) {
        ...
        changed = false;
      currVal_1 = J.$index$asx(t1.ctx._item, local_key);
      t1 = _this._expr_1;
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Iterable, [A._CastIterableBase, A.EfficientLengthIterable, A.MappedIterable, A.ExpandIterable, A._KeysOrValues]);
...
;
    ...
    B.Object_EVk = {computeConstantValue: 0, element: 1, hashCode: 2, isAlwaysThrows: 3, isConstantEvaluated: 4, isDeprecated: 5, isDoNotStore: 6, isFactory: 7, isImmutable: 8, isInternal: 9, isIsTest: 10, isIsTestGroup: 11, isJS: 12, isLiteral: 13, isMustBeOverridden: 14, isMustCallSuper: 15, isNonVirtual: 16, isOptionalTypeArgs: 17, isOverride: 18, isProtected: 19, isProxy: 20, isRedeclare: 21, isReopen: 22, isRequired: 23, isSealed: 24, isTarget: 25, isUseResult: 26, isVisibleForOverriding: 27, isVisibleForTemplate: 28, isVisibleForTesting: 29, isVisibleOutsideTemplate: 30, library: 31, toSource: 32, toString: 33, constantEvaluationErrors: 34, context: 35, librarySource: 36, runtimeType: 37, source: 38};
    B.Object_wTU = {type: 0, valueType: 1, value: 2, kind: 3};
    B.Object_type_0 = {type: 0};
    B.Map_KPPy3 = new A.ConstantStringMap(B.Object_type_0, ["ElementAnnotation"], type$.ConstantStringMap_String_String);
    B.Map_ckuUr = new A.ConstantStringMap(B.Object_wTU, ["DartObject?", "DartObjectImpl", B.Map_KPPy3, "known"], type$.ConstantStringMap_String_Object);
    B.Map_ckw1y = new A.ConstantStringMap(B.Object_wTU, ["Element?", "ConstructorElementImpl", B.Map_KPPy3, "known"], type$.ConstantStringMap_String_Object);
    B.Map_ck2bx = new A.ConstantStringMap(B.Object_wTU, ["int", "int", 374259371, "constant"], type$.ConstantStringMap_String_Object);
    B.Map_ck1xC = new A.ConstantStringMap(B.Object_wTU, ["bool", "bool", false, "constant"], type$.ConstantStringMap_String_Object);
    B.Map_ck1xC0 = new A.ConstantStringMap(B.Object_wTU, ["bool", "bool", true, "constant"], type$.ConstantStringMap_String_Object);
    B.Map_ckhw4 = new A.ConstantStringMap(B.Object_wTU, ["LibraryElement?", "LibraryElementImpl", B.Map_KPPy3, "known"], type$.ConstantStringMap_String_Object);
    B.Map_ckSDM = new A.ConstantStringMap(B.Object_wTU, ["String", "String", "@Ann('bufFFF', foo: 123, ann: ann2)", "constant"], type$.ConstantStringMap_String_Object);
    B.Map_ckDx1 = new A.ConstantStringMap(B.Object_wTU, ["String", "String", "@Ann Ann(String buf, {required double foo, int? nn, Ann? ann})", "constant"], type$.ConstantStringMap_String_Object);
    B.Map_ckkmo = new A.ConstantStringMap(B.Object_wTU, ["AnalysisError", "List<AnalysisError>", "List<AnalysisError>", "unknown"], type$.ConstantStringMap_String_Object);
    B.Map_ckWVp = new A.ConstantStringMap(B.Object_wTU, ["AnalysisContext", "AnalysisContextImpl", "AnalysisContext", "unknown"], type$.ConstantStringMap_String_Object);
    B.Map_ckkGC = new A.ConstantStringMap(B.Object_wTU, ["Source?", "FileSource", "FileSource", "unknown"], type$.ConstantStringMap_String_Object);
    B.Map_ckyHF = new A.ConstantStringMap(B.Object_wTU, ["Type", "Type", "Type", "unknown"], type$.ConstantStringMap_String_Object);
    B.Map_WVgPO = new A.ConstantStringMap(B.Object_EVk, [B.Map_ckuUr, B.Map_ckw1y, B.Map_ck2bx, B.Map_ck1xC, B.Map_ck1xC0, B.Map_ck1xC, B.Map_ck1xC, B.Map_ck1xC, B.Map_ck1xC, B.Map_ck1xC, B.Map_ck1xC, B.Map_ck1xC, B.Map_ck1xC, B.Map_ck1xC, B.Map_ck1xC, B.Map_ck1xC, B.Map_ck1xC, B.Map_ck1xC, B.Map_ck1xC, B.Map_ck1xC, B.Map_ck1xC, B.Map_ck1xC, B.Map_ck1xC, B.Map_ck1xC, B.Map_ck1xC, B.Map_ck1xC, B.Map_ck1xC, B.Map_ck1xC, B.Map_ck1xC, B.Map_ck1xC, B.Map_ck1xC, B.Map_ckhw4, B.Map_ckSDM, B.Map_ckDx1, B.Map_ckkmo, B.Map_ckWVp, B.Map_ckkGC, B.Map_ckyHF, B.Map_ckkGC], A.findType("ConstantStringMap<String,Map<String,Object>>"));
    B.Object_WUm = {accessors: 0, augmentation: 1, augmentationTarget: 2, augmented: 3, children: 4, constructors: 5, declaration: 6, displayName: 7, documentationComment: 8, enclosingElement: 9, fields: 10, hasAlwaysThrows: 11, hasDeprecated: 12, hasDoNotStore: 13, hasFactory: 14, hasInternal: 15, hasIsTest: 16, hasIsTestGroup: 17, hasJS: 18, hasLiteral: 19, hasMustBeOverridden: 20, hasMustCallSuper: 21, hasNonFinalField: 22, hasNonVirtual: 23, hasOptionalTypeArgs: 24, hasOverride: 25, hasProtected: 26, hasRedeclare: 27, hasReopen: 28, hasRequired: 29, hasSealed: 30, hasUseResult: 31, hasVisibleForOverriding: 32, hasVisibleForTemplate: 33, hasVisibleForTesting: 34, hasVisibleOutsideTemplate: 35, hashCode: 36, id: 37, isAbstract: 38, isAugmentation: 39, isBase: 40, isConstructable: 41, isDartCoreEnum: 42, isDartCoreObject: 43, isExhaustive: 44, isFinal: 45, isInline: 46, isInterface: 47, isMixinApplication: 48, isMixinClass: 49, isPrivate: 50, isPublic: 51, isSealed: 52, isSimplyBounded: 53, isSynthetic: 54, isValidMixin: 55, kind: 56, library: 57, location: 58, metadata: 59, methods: 60, name: 61, nameLength: 62, nameOffset: 63, nonSynthetic: 64, thisOrAncestorOfType: 65, toString: 66, typeParameters: 67, unnamedConstructor: 68, allSupertypes: 69, context: 70, interfaces: 71, librarySource: 72, mixins: 73, runtimeType: 74, session: 75, sinceSdkVersion: 76, source: 77, supertype: 78, thisType: 79};
    B.Object_6QF = {type: 0, valueType: 1, length: 2, viewable: 3, kind: 4};
    B.Map_atmNZ = new A.ConstantStringMap(B.Object_6QF, ["PropertyAccessorElement", "List<PropertyAccessorElementImpl>", 9, true, "list"], type$.ConstantStringMap_of_String_and_nullable_Object);
    B.Map_KPifn = new A.ConstantStringMap(B.Object_type_0, ["ClassElement"], type$.ConstantStringMap_String_String);
    B.Map_ckbY5 = new A.ConstantStringMap(B.Object_wTU, ["ClassElement?", null, B.Map_KPifn, "known"], type$.ConstantStringMap_of_String_and_nullable_Object);
    B.Map_ckCW0 = new A.ConstantStringMap(B.Object_wTU, ["AugmentedClassElement?", "NotAugmentedClassElementImpl", B.Map_KPifn, "known"], type$.ConstantStringMap_of_String_and_nullable_Object);
    B.Map_atQEb = new A.ConstantStringMap(B.Object_6QF, ["Element", "List<Element>", 16, true, "list"], type$.ConstantStringMap_of_String_and_nullable_Object);
    B.Map_at6FR = new A.ConstantStringMap(B.Object_6QF, ["ConstructorElement", "List<ConstructorElementImpl>", 1, true, "list"], type$.ConstantStringMap_of_String_and_nullable_Object);
    B.Map_ckoS9 = new A.ConstantStringMap(B.Object_wTU, ["Element?", "ClassElementImpl", B.Map_KPifn, "known"], type$.ConstantStringMap_of_String_and_nullable_Object);
    B.Map_ckyPG = new A.ConstantStringMap(B.Object_wTU, ["String", "String", "FullClass", "constant"], type$.ConstantStringMap_of_String_and_nullable_Object);
    B.Map_ck2bH = new A.ConstantStringMap(B.Object_wTU, ["String?", "String", "/// Oh Yeah some doc!", "constant"], type$.ConstantStringMap_of_String_and_nullable_Object);
    B.Map_ckqZo = new A.ConstantStringMap(B.Object_wTU, ["CompilationUnitElement", "CompilationUnitElementImpl", B.Map_KPifn, "known"], type$.ConstantStringMap_of_String_and_nullable_Object);
    B.Map_atuLy = new A.ConstantStringMap(B.Object_6QF, ["FieldElement", "List<FieldElementImpl>", 5, true, "list"], type$.ConstantStringMap_of_String_and_nullable_Object);
    B.Map_ck1xC1 = new A.ConstantStringMap(B.Object_wTU, ["bool", "bool", false, "constant"], type$.ConstantStringMap_of_String_and_nullable_Object);
    B.Map_ck1xC2 = new A.ConstantStringMap(B.Object_wTU, ["bool", "bool", true, "constant"], type$.ConstantStringMap_of_String_and_nullable_Object);
    B.Map_ckYJ8 = new A.ConstantStringMap(B.Object_wTU, ["int", "int", 221724925, "constant"], type$.ConstantStringMap_of_String_and_nullable_Object);
    B.Map_ckomC = new A.ConstantStringMap(B.Object_wTU, ["int", "int", 18661, "constant"], type$.ConstantStringMap_of_String_and_nullable_Object);
    B.Map_ck8aB = new A.ConstantStringMap(B.Object_wTU, ["ElementKind", "ElementKind", B.Map_KPifn, "known"], type$.ConstantStringMap_of_String_and_nullable_Object);
    B.Map_ckIY4 = new A.ConstantStringMap(B.Object_wTU, ["LibraryElement?", "LibraryElementImpl", B.Map_KPifn, "known"], type$.ConstantStringMap_of_String_and_nullable_Object);
    B.Map_ckClv = new A.ConstantStringMap(B.Object_wTU, ["ElementLocation?", "ElementLocationImpl", B.Map_KPifn, "known"], type$.ConstantStringMap_of_String_and_nullable_Object);
    B.Map_atQ0b = new A.ConstantStringMap(B.Object_6QF, ["ElementAnnotation", "List<ElementAnnotation>", 1, true, "list"], type$.ConstantStringMap_of_String_and_nullable_Object);
    B.Map_atkmC = new A.ConstantStringMap(B.Object_6QF, ["MethodElement", "List<MethodElementImpl>", 1, true, "list"], type$.ConstantStringMap_of_String_and_nullable_Object);
    B.Map_ckomC0 = new A.ConstantStringMap(B.Object_wTU, ["int", "int", 9, "constant"], type$.ConstantStringMap_of_String_and_nullable_Object);
    B.Map_ckomC1 = new A.ConstantStringMap(B.Object_wTU, ["int", "int", 176, "constant"], type$.ConstantStringMap_of_String_and_nullable_Object);
    B.Map_ckQPf = new A.ConstantStringMap(B.Object_wTU, ["Element", "ClassElementImpl", B.Map_KPifn, "known"], type$.ConstantStringMap_of_String_and_nullable_Object);
    B.Map_ckwEo = new A.ConstantStringMap(B.Object_wTU, ["String", "String", "final class FullClass extends SuperClass<dynamic> with Mixer, Mixer2 implements SuperInterface<num, SuperInterface2<String>, num>, SuperInterface3<SuperInterface2<SuperInterface2<num>>>", "constant"], type$.ConstantStringMap_of_String_and_nullable_Object);
    B.Map_atxw8 = new A.ConstantStringMap(B.Object_6QF, ["TypeParameterElement", "List<TypeParameterElement>", 0, true, "list"], type$.ConstantStringMap_of_String_and_nullable_Object);
    B.Map_ck1XY = new A.ConstantStringMap(B.Object_wTU, ["ConstructorElement?", "ConstructorElementImpl", B.Map_KPifn, "known"], type$.ConstantStringMap_of_String_and_nullable_Object);
    B.Object_atP = {type: 0, valueType: 1, length: 2, kind: 3};
    B.Map_UWbfP = new A.ConstantStringMap(B.Object_atP, ["InterfaceType", "List<InterfaceType>", 6, "list"], type$.ConstantStringMap_of_String_and_nullable_Object);
    B.Map_ckWVp0 = new A.ConstantStringMap(B.Object_wTU, ["AnalysisContext", "AnalysisContextImpl", "AnalysisContext", "unknown"], type$.ConstantStringMap_of_String_and_nullable_Object);
    B.Map_UWbfP0 = new A.ConstantStringMap(B.Object_atP, ["InterfaceType", "List<InterfaceType>", 2, "list"], type$.ConstantStringMap_of_String_and_nullable_Object);
    B.Map_ckkGC0 = new A.ConstantStringMap(B.Object_wTU, ["Source?", "FileSource", "FileSource", "unknown"], type$.ConstantStringMap_of_String_and_nullable_Object);
    B.Map_ckyHF0 = new A.ConstantStringMap(B.Object_wTU, ["Type", "Type", "Type", "unknown"], type$.ConstantStringMap_of_String_and_nullable_Object);
    B.Map_ckgvk = new A.ConstantStringMap(B.Object_wTU, ["AnalysisSession?", "AnalysisSessionImpl", "AnalysisSession", "unknown"], type$.ConstantStringMap_of_String_and_nullable_Object);
    B.Map_ck9yJ = new A.ConstantStringMap(B.Object_wTU, ["Version?", null, "Null", "unknown"], type$.ConstantStringMap_of_String_and_nullable_Object);
    B.Map_ckwMy = new A.ConstantStringMap(B.Object_wTU, ["InterfaceType?", "InterfaceTypeImpl", "InterfaceType", "unknown"], type$.ConstantStringMap_of_String_and_nullable_Object);
    B.Map_ckbY50 = new A.ConstantStringMap(B.Object_wTU, ["InterfaceType", "InterfaceTypeImpl", "InterfaceType", "unknown"], type$.ConstantStringMap_of_String_and_nullable_Object);
    B.Map_wwVUC = new A.ConstantStringMap(B.Object_WUm, [B.Map_atmNZ, B.Map_ckbY5, B.Map_ckbY5, B.Map_ckCW0, B.Map_atQEb, B.Map_at6FR, B.Map_ckoS9, B.Map_ckyPG, B.Map_ck2bH, B.Map_ckqZo, B.Map_atuLy, B.Map_ck1xC1, B.Map_ck1xC1, B.Map_ck1xC1, B.Map_ck1xC1, B.Map_ck1xC1, B.Map_ck1xC1, B.Map_ck1xC1, B.Map_ck1xC1, B.Map_ck1xC1, B.Map_ck1xC1, B.Map_ck1xC1, B.Map_ck1xC2, B.Map_ck1xC1, B.Map_ck1xC1, B.Map_ck1xC1, B.Map_ck1xC1, B.Map_ck1xC1, B.Map_ck1xC1, B.Map_ck1xC1, B.Map_ck1xC1, B.Map_ck1xC1, B.Map_ck1xC1, B.Map_ck1xC1, B.Map_ck1xC1, B.Map_ck1xC1, B.Map_ckYJ8, B.Map_ckomC, B.Map_ck1xC1, B.Map_ck1xC1, B.Map_ck1xC1, B.Map_ck1xC2, B.Map_ck1xC1, B.Map_ck1xC1, B.Map_ck1xC1, B.Map_ck1xC2, B.Map_ck1xC1, B.Map_ck1xC1, B.Map_ck1xC1, B.Map_ck1xC1, B.Map_ck1xC1, B.Map_ck1xC2, B.Map_ck1xC1, B.Map_ck1xC2, B.Map_ck1xC1, B.Map_ck1xC1, B.Map_ck8aB, B.Map_ckIY4, B.Map_ckClv, B.Map_atQ0b, B.Map_atkmC, B.Map_ckyPG, B.Map_ckomC0, B.Map_ckomC1, B.Map_ckQPf, B.Map_ckoS9, B.Map_ckwEo, B.Map_atxw8, B.Map_ck1XY, B.Map_UWbfP, B.Map_ckWVp0, B.Map_UWbfP0, B.Map_ckkGC0, B.Map_UWbfP0, B.Map_ckyHF0, B.Map_ckgvk, B.Map_ck9yJ, B.Map_ckkGC0, B.Map_ckwMy, B.Map_ckbY50], A.findType("ConstantStringMap<String,Map<String,Object?>>"));
